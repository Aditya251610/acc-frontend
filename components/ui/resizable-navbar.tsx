...
export const Navbar = ({ children, className }: NavbarProps) => {
  // Use the page scroll position so the resize animation works for fixed navbars.
  ...
  return (
    <motion.div
      // Default to fixed so public nav stays visible while scrolling.
      // Sidebar nav passes its own positioning classes (e.g., sticky + left).
